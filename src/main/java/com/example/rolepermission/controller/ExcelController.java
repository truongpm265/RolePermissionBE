...
public class ExcelController {
    ...
    public ResponseEntity<byte[]> exportToExcel() {
        ...
        List<Role> roles = roleService.getAllRolesObject();
        ...
        headerRow.createCell(4).setCellValue("Function");
        for (int i = 0; i < 5; i++) {
            ...
            if (user.getRoles() != null) {
                for (Role role : user.getRoles()) {
                    if (role.getFunctions() != null) {
                        for (AppFunction function : role.getFunctions()) {
                            permissionsString.append(function.getName()).append(", ");
                        }
                    }
                }
        ...
        headerRoleRow.createCell(2).setCellValue("Functions");
        ...
        for (Role role : roles) {
            ...
            if (role.getFunctions() != null) {
                for (AppFunction function : role.getFunctions()) {
                    permmissionRoleString.append(function.getName()).append(", ");
                }
